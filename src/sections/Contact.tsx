...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-32 px-6 bg-mono-950 relative">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-mono-400 text-lg max-w-2xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
          <MagneticButton
            ...
            className="px-12 py-5 bg-white text-black font-mono text-sm tracking-widest uppercase hover:bg-mono-200 transition-colors rounded-full"
          >
            Send Email
          </MagneticButton>
          <MagneticButton
